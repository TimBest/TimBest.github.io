...
const ComposersCouch = () => (
  <main style={{ padding: 50 }}>
    ...
    <div className="defanged1-my-gallery defanged1-flex-row-space-between">
      <figure>
        <StaticImage src="../images/composers_couch/homescreen.png" alt="homescreen" />
        <figcaption>'Sign up' and 'Login' forms are embedded into the home screen for quick access.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/auth_login.png" alt="auth_login" />
        <figcaption>Users are authenticated through Facebook, Twitter or an email address and password.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/auth_signup.png" alt="auth_signup" />
      ...
      <figure>
        <StaticImage src="../images/composers_couch/auth_signup_social.png" alt="auth_signup_social" />
    ...
    <div className="defanged1-my-gallery defanged1-flex-row-space-between">
      <figure>
        <StaticImage src="../images/composers_couch/inbox.png" alt="inbox" />
        <figcaption>All messages can be viewed and accessed here.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/inbox_sent.png" alt="inbox_sent" />
        <figcaption>Any message sent or replied to can be found here.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/inbox_trash.png" alt="inbox_trash" />
        <figcaption>When deleted, threads are moved to the trash.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/inbox_public_requests_sent.png" alt="inbox_public_requests_sent" />
        <figcaption>Filtering the inbox by message type allows for more detailed message views.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/inbox_public_request_application.png" alt="inbox_public_request_application" />
      ...
      <figure>
        <StaticImage src="../images/composers_couch/inbox_private_request.png" alt="inbox_private_request" />
        <figcaption>Private request allowed for planning shows and quick porting to your calendar.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/inbox_event_notification.png" alt="inbox_event_notification" />
        <figcaption>Messages are sent to all site users when they are entered as a participant in a show.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/inbox_message.png" alt="inbox_message" />
    ...
    <div className="defanged1-my-gallery defanged1-flex-row-space-between">
      <figure>
        <StaticImage src="../images/composers_couch/calendar_month.png" alt="calendar_month" />
        <figcaption>Month view.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/calendar_month_expanded.png" alt="calendar_month_expanded" />
      ...
      <figure>
        <StaticImage src="../images/composers_couch/calendar_year.png" alt="calendar_year" />
        <figcaption>Can view the entire year and quickly jump to a month, week, day or single event.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/calendar_day.png" alt="calendar_day" />
        <figcaption>Single day view.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/calendar_add_show.png" alt="calendar_add_show" />
    ...
    <div className="defanged1-my-gallery defanged1-flex-row-space-between">
      <figure>
        <StaticImage src="../images/composers_couch/feeds_requests.png" alt="feeds_requests" />
        <figcaption>Public Request can be browsed by location, who they are looking for, just posted and about to expire.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/feeds_requests_filter.png" alt="feeds_requests_filter" />
        <figcaption>All feeds can be filtered by a single genre group or by genres saved to your profile.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/feeds_shows.png" alt="feeds_shows" />
      ...
      <figure>
        <StaticImage src="../images/composers_couch/feeds_artists.png" alt="feeds_artists" />
      ...
      <figure>
        <StaticImage src="../images/composers_couch/feeds_venues.png" alt="feeds_venues" />
        <figcaption>Quickly search for a venue near you or find one that has an opening.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/feeds_updates.png" alt="feeds_updates" />
    ...
    <div className="defanged1-my-gallery defanged1-flex-row-space-between">
      <figure>
        <StaticImage src="../images/composers_couch/artist_about.png" alt="artist_about" />
        <figcaption></figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/artist_news.png" alt="artist_news" />
        <figcaption>Recent stories in the news and current content the artist wants to promote.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/artist_shows.png" alt="artist_shows" />
        <figcaption>All shows that the artist has made visible.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/artist_music.png" alt="artist_music" />
      ...
      <figure>
        <StaticImage src="../images/composers_couch/artist_photos.png" alt="artist_photos" />
        <figcaption>A collection of all photos uploaded by the user.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/artist_videos.png" alt="artist_videos" />
    ...
    <div className="defanged1-my-gallery defanged1-flex-row-space-between">
      <figure>
        <StaticImage src="../images/composers_couch/venue_about.png" alt="venue_about" />
        <figcaption></figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/venue_news.png" alt="venue_news" />
        <figcaption>Recent stories in the news and current content the venue wants to promote.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/venue_shows.png" alt="venue_shows" />
        <figcaption>All shows that the venue has made visible.</figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/venue_photos.png" alt="venue_photos" />
    ...
    <div className="defanged1-my-gallery defanged1-flex-row-space-between">
      <figure>
        <StaticImage src="../images/composers_couch/static_about.png" alt="static_about" />
        <figcaption></figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/static_learn_more.png" alt="static_learn_more" />
        <figcaption></figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/static_changelog.png" alt="static_changelog" />
        <figcaption></figcaption>
      </figure>

      <figure>
        <StaticImage src="../images/composers_couch/static_pipeline.png" alt="static_pipeline" />
        <figcaption></figcaption>
      </figure>
